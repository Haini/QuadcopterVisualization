...
## Generated on : Thu Aug 02 15:30:38 2018
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/control_system
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/consti/Uni/Bachelorarbeit/SimulinkBenchCandidates/lechner_extEngine/project
ARCH                      = glnxa64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/control_system
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/control_system_ert_rtw -I$(START_DIR) -I$(START_DIR)/subsystems -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=control_system -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/control_system_ert_rtw/control_system.c $(START_DIR)/control_system_ert_rtw/control_system_data.c

MAIN_SRC = $(START_DIR)/control_system_ert_rtw/ert_main.c
