###########################################################################
## Makefile generated for Simulink model 'quadcopter_dynamic_model'. 
## 
## Makefile     : quadcopter_dynamic_model.mk
## Generated on : Thu Sep 13 12:07:57 2018
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/quadcopter_dynamic_model
...
PRODUCT_NAME              = quadcopter_dynamic_model
MAKEFILE                  = quadcopter_dynamic_model.mk
COMPUTER                  = GLNXA64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/consti/Uni/Bachelorarbeit/SimulinkBenchCandidates/modular_design/dynamic_model/project
ARCH                      = glnxa64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = quadcopter_dynamic_model_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/quadcopter_dynamic_model
...
INCLUDES_BUILDINFO = -I./referenced_model_includes -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/quadcopter_dynamic_model_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=quadcopter_dynamic_model -DNUMST=7 -DNCSTATES=13 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/quadcopter_dynamic_model_ert_rtw/quadcopter_dynamic_model.c

MAIN_SRC = $(START_DIR)/quadcopter_dynamic_model_ert_rtw/ert_main.c
...
OBJS = quadcopter_dynamic_model.o
...
MODELREF_LIBS = ./dynamic_model_rtwlib.a
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS) $(MAIN_OBJ)
	...
	$(LD) $(LDFLAGS) -o $(PRODUCT) $(OBJS) $(MAIN_OBJ) -Wl,--start-group $(MODELREF_LIBS) -Wl,--end-group $(LIBS) $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
%.o : $(START_DIR)/quadcopter_dynamic_model_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/quadcopter_dynamic_model_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
